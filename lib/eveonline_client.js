Eveonline.requestCredential = function (options, credentialRequestCompleteCallback) {
  ...
  var loginUrl = (config.isTest ? 'https://sisilogin.testeveonline.com/oauth/authorize' : 'https://login.eveonline.com/oauth/authorize') +
    '?response_type=code' +
  ...
  OAuth.initiateLogin(credentialToken, loginUrl, credentialRequestCompleteCallback, {width: 650, height: 650});
};
